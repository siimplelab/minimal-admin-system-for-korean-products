    ...
    <div className="space-y-3">
      ...
      <section className="grid gap-2 sm:grid-cols-3">
        <article className="panel-inset px-3 py-2">
          <p className="text-[12px] text-[var(--foreground-muted)]">총 운영 계정</p>
          <p className="mt-1 text-lg font-semibold text-[var(--foreground-strong)]">
            {userRows.length}명
          </p>
        </article>
        <article className="panel-inset px-3 py-2">
          <p className="text-[12px] text-[var(--foreground-muted)]">활성 계정</p>
          <p className="mt-1 text-lg font-semibold text-[var(--foreground-strong)]">
            {userRows.filter((row) => row.상태 === "사용중").length}명
          </p>
        </article>
        <article className="panel-inset px-3 py-2">
          <p className="text-[12px] text-[var(--foreground-muted)]">대기/중지</p>
          <p className="mt-1 text-lg font-semibold text-[var(--foreground-strong)]">
            {
      ...
      <DataTable
        ...
        rowActions={(row) => (
          <div className="space-y-0.5 text-[13px]">
            <button
              type="button"
              className="flex w-full items-center gap-2 rounded px-2 py-1 text-left hover:bg-[var(--surface-muted)]"
            ...
            <button
              type="button"
              className="flex w-full items-center gap-2 rounded px-2 py-1 text-left text-[#991b1b] hover:bg-[#fef2f2]"
